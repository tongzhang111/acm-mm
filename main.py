...
def get_args_parser():
    ...
    parser.add_argument('--set_cost_class', default=0.2, type=float,
    ...
    parser.add_argument("--hsbbox_loss_coef", default=5, type=float)
    parser.add_argument("--hsgiou_loss_coef", default=2, type=float)
    parser.add_argument("--sted_loss_coef", default=10, type=float)
    parser.add_argument("--label_loss_coef", default=0.2, type=float) #2->1
    parser.add_argument("--cross_sim", default=2, type=float) #1->2
    ...
    parser.add_argument("--stride", type=int, default=1, help="temporal stride k")
    parser.add_argument(
        "--fps",
        type=int,
        default=5,
